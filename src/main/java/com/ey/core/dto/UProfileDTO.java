...
public class UProfileDTO {
	...
	/*
	 * @XmlElement(name = "id") public Integer getId() { return id; }
	 * 
	 ...
	 * 
	 * @XmlElement(name = "registrationTimer") public Integer getRegistrationTimer()
	 ...
	 * 
	 * @XmlElement(name = "ageoffTimer") public Integer getAgeoffTimer() { return
	 * ageoffTimer; }
	 * 
	 * public void setAgeoffTimer(Integer ageoffTimer) { this.ageoffTimer =
	 * ageoffTimer; }
	 * 
	 * @XmlElement(name = "isConsole") public Boolean getIsConsole() { return
	 * isConsole; }
	 * 
	 * public void setIsConsole(Boolean isConsole) { this.isConsole = isConsole; }
	 * 
	 * @XmlElement(name = "isSpoolingEnabled") public Boolean getIsSpoolingEnabled()
	 ...
	 * 
	 * @XmlElement(name = "isOpenEnterprise") public Boolean getIsOpenEnterprise() {
	 * return isOpenEnterprise; }
	 * 
	 * public void setIsOpenEnterprise(Boolean isOpenEnterprise) {
	 * this.isOpenEnterprise = isOpenEnterprise; }
	 * 
	 * @XmlElement(name = "ltePagingCycle") public PageCycle getLtePagingCycle() {
	 * return ltePagingCycle; }
	 * 
	 * public void setLtePagingCycle(PageCycle ltePagingCycle) { this.ltePagingCycle
	 * = ltePagingCycle; }
	 */
}
