...
public class MessageUtil {
	...
	public static final String BOTH_CKR_CKRLIST_REQUIRED = "both ckr and ckrList required!!";
	public static final String CKR_INVALID = "ckr range is invalid";
	public static final String ENTERPRISE_NAME_ALREADY_EXISTS = "Enterprise Name already exists";
	public static final String ENTERPRISE_NAME_DOESNOT_EXISTS = "Enterprise Name doesnot exists";
	public static final String ENTERPRISE_NAME_CANNOT_BE_MODIFIED = "Enterprise Name cannot be changed";
	...
	public static final String SUSPENEDED_NOT_ALLOWED = "Suspended parameter is not allowed";

	public static final String MDN_ALREADY_EXISTS = "MDN already exists";
	public static final String MIN_ALREADY_EXISTS = "MIN already exists";
	public static final String UFMI_ALREADY_EXISTS = "UFMI already exists";
	public static final String COS_DOESNOT_EXISTS = "Class of Service does not exist";
